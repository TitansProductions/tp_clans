...
1. Fixed an issue that occured on new clans turning the `kicked_members` data to null, that data would throw errors on the server console and making the members to not be functional properly. This update also fixes already broken data once the script is started.
