...
2. Improved data triggers from using `TriggerClientEventAsyncByCoords` to `TriggerClientClanUpdateEvent` on not required data to be sent for everyone but only on the updated clan.
