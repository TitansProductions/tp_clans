...
1. Fixed an issue with the furnitures, they could be bought without any money limitation and could cause the balance of the clan to go negative value.
2. Added when script starts and find a clan that has negative balance to reset it back to 0.
