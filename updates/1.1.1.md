...
1. Fixed an issue on new created clans, there were some errors that could occur related to new members invitation. This error would fix upon server restart but it is no longer a problem. This was caused because of the new data of `kicked_members` that was missing when creating a new clan.
